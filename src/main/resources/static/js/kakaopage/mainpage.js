...
class MainPageApi {
    ...
    getTotalCount() {
        ...
        $.ajax({
            async: false,
            type: "get",
            url: ":8000/api/hot/search/totalcount",
            data: searchObj,
            dataType: "json",
            success: response => {
...
class MainPageService {
    ...
    loadNewEmos() {
        ...
        responseData.forEach((data, index) => {
            contentFlex.innerHTML +=`
                <li>
                    <a class="index-link" href=":8000/main/detail/?emoCode=${data.emoCode}">
                        <img src=":8000/image/emo/${data.newImage1 != null ? data.newImage1  : "noimg.jpg"}" alt="" class="emo-img">
    ...
    loadHotEmos() {
        ...
        responseData.forEach((data, index) => {
            contentFlex.innerHTML +=`
                <li>
                    <a class="index-hot-link" href=":8000/main/detail/?emoCode=${data.emoCode}">
                        ...
                        <div class=".index-img-box">
                            <img src=":8000/image/emo/${data.saveName != null ? data.saveName : "noimg.jpg"}" alt="" class="emo-img">
                        </div>
                    </a>
                </li>
            `
